            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <img src="https://files-cdn.chatway.app/assets/images/logo-text.svg" alt="Chatway" class="h-8 w-auto" />
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="mt-1 text-xs text-gray-400">Role: {{ Auth::user()->role_label }}</div>
            </div>
